...
//acer demovideo start
static const char *DEMO_MODE_FILE = "/cache/recovery/last_demo_mode"; //add by NavyGuo for Acer Demo mode
//acer demovideo end
    ...
    for (;;) {
        ...
        switch (chosen_action) {
            ...
            case Device::RUN_GRAPHICS_TEST:
                ...
                break;
            case Device::DEMO_MODE:
                demo_mode_fp = fopen_path(DEMO_MODE_FILE, "w");
                if(demo_mode_fp != NULL) {
       	            check_and_fclose(demo_mode_fp, DEMO_MODE_FILE);
                }
                break;
...
int main(int argc, char **argv) {
    ...
    if (update_package != NULL) {
        ...
        unlink("/cache/recovery/last_demo_mode"); //add by NavyGuo for Acer Demo mode
